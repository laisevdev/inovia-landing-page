      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-background border border-border">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Email Corporativo */}
            <div className="space-y-2">
              <Label htmlFor="email_corporativo" className="text-sm font-medium text-foreground">
          ...
          <div className="space-y-2">
            <Label htmlFor="desafios_objetivos" className="text-sm font-medium text-foreground">
              Desafios e Objetivos
            </Label>
            <Textarea
          ...
          <div className="pt-4">
            <Button
              ...
              className="w-full py-3 text-sm font-semibold bg-primary hover:bg-primary/90 transition-all duration-300"
              size="lg"
            >
              {isSubmitting ? (
